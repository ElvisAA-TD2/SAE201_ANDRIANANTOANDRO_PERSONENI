...
namespace SAE201_ANDRIANANTOANDRO_PERSONENI.Model
{
    public class Type
    {
        ...
        public List<Type> FindAll(ObservableCollection<Categorie> lesCategorie)
        {
            ...
            using (NpgsqlCommand cmdSelect = new NpgsqlCommand("select * from type ;"))
            {
                ...
                foreach (DataRow dr in dt.Rows)
                    lesTypes.Add(new Type((Int32)dr["numtype"], (String)dr["libelletypepointe"],
                        lesCategorie.SingleOrDefault(c => c.CodeCategorie == (Int32)dr["numcategorie"])));
            }
            return lesTypes;
        }
    }
